                    ...
                    <div className='relative'>
                        <div className='flex gap-large'>
                            <div className='flex align-center gap-medium'>
                                ...
                                <input type='radio' id='indoor' name='seatingType' value='indoors' checked={formik.values.seatingType === 'indoors'} onChange={formik.handleChange}  onBlur={formik.handleBlur} />
                            </div>
                            <div className='flex  align-center gap-medium'>
                                <label htmlFor="outdoor">Outdoor Seating</label>
                                <input type='radio' id='outdoor' name='seatingType' value='outdoors' checked={formik.values.seatingType === 'outdoors'} onChange={formik.handleChange}  onBlur={formik.handleBlur} />
                            </div>
                        </div>
